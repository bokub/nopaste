...
[NoPaste](https://nopaste.blankdvth.com/) is an open-source website similar to Pastebin where you can store any piece of code, and generate links for easy sharing
...
[Base64](https://en.wikipedia.org/wiki/Base64), and puts it in the optional URL fragment, after the first `#` symbol: `nopaste.blankdvth.com/#<your data goes here>`
...
<iframe
    ...
    height="243"
    frameborder="0"
    src="https://nopaste.blankdvth.com/?l=py#"
></iframe>
```
...
What if you have no internet connection at all? No problem, NoPaste will still work perfectly!
